...
function Footer() {
  return (
    <>
      <div className="bg-[#000000] h-1/2 w-full flex md:flex-row flex-col justify-around items-center md:items-start">
        <div className="p-5 ">
          <ul>
            <p className="text-white font-bold text-3xl pb-6">
              Founders<span className="text-blue-600"> CLUB</span>
            </p>
            <div className="flex flex-row gap-6 pb-5 text-white items-center md:items-start">
        ...
        <div className='flex flex-row items-start gap-12 md:gap-36'>
          <div className="p-5">
            <ul >
      ...
      <div className="flex flex-col justify-center items-center text-center  text-white p-5 bg-[#000000]">
        <span className="hover:text-blue-600 font-semibold cursor-pointer">
          <Link href="/">©Founder's Club 2024 | All Rights Reserved </Link>
        </span>
      </div>
    </>
  )
